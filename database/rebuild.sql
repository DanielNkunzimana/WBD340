...
-- query statement by using select keyword
...
-- query statement by using update keyword

UPDATE public.classification
SET classification_name = 'Christopher Clombus'
...
-- query statement by using delete keyword
...
WHERE classification_id = 1;
-- query statement on account table
